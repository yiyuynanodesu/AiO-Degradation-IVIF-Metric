...
from MUSIQ.option.config import Config
from MUSIQ.model.backbone import resnet50_backbone
from MUSIQ.model.model_main import IQARegression
...
config = Config({
    ...
    'checkpoint': './MUSIQ/weights/MUSIQepoch100.pth',                              # weights of trained model
...
def evaluate_image(image_path):
    ...
    d_img_org = cv2.imread(image_path)
